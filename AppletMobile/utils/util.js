...
function getDiffTime(endTime){
  ...
  let h = parseInt((end_date.getTime() - current_date.getTime()) / (1000 * 60 * 60))
  let m = parseInt((end_date.getTime() - current_date.getTime()) % (1000 * 60 * 60 * 24) % (1000 * 60 * 60) / (1000 * 60))
  let s = parseInt((end_date.getTime() - current_date.getTime()) % (1000 * 60 * 60 * 24) % (1000 * 60 * 60) % (1000 * 60) / 1000)
  h = h < 10 ? "0"+h : h
  m = m < 10 ? "0" + m : m
  s = s < 10 ? "0" + s : s
  res = h + ":" + m + ":" + s
